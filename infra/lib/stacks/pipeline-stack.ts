...
export class PipelineStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: PipelineStackProps) {
    ...
    new FrontendStack(deployStage, "SakaiNGFrontend-prod", {
      stackName: "SakaiNGFrontend-prod",
      environment: "prod",
      buildOutputPath: "../dist/sakai-ng/browser",
    });
